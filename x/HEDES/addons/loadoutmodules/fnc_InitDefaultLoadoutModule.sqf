...
{
	GVAR(ALLLOADOUTNAMEPLATERS) pushback _x;
	_x addAction ["Get default unit loadout...", {(_this select 1) setUnitLoadout (_this select 3)}, _loadout, 1.5, true, true, "", "true", 10];
