...
Description:
	Used by mission specific tasks to find random pos and place 
	marker + assign task.
...
private _taskicon = param[4, "attack"];
...
[_group, [_missionTask], [_tasktitl, _taskdesc], _randomPos, 1, 3, true, _taskicon] call BIS_fnc_taskCreate;
